...
class WindowModel(NERModel):
    ...
    def add_embedding(self):
        ...
        embeddings = tf.reshape(tensor=embeddings, shape=[-1, self.config.n_window_features * self.config.embed_size])
        ### END YOUR CODE
        return embeddings
    ...
    def add_prediction_op(self):
        ...
        W = tf.get_variable(name='W', initializer=tf.contrib.layers.xavier_initializer(), shape=(self.config.n_window_features * self.config.embed_size,
